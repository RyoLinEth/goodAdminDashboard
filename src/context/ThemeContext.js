...
const ThemeContextProvider = (props) => {
  ...
  const languageOptions = [
    ...
    { value: "traditionalchinese", label: "TraditionalChinese" },
  ]

  const changeLanguage = (name) => {
    dispatch({ language: name });
    body.setAttribute("data-language", name);
  }
  ...
  const setDemoTheme = (theme, direction) => {
    ...
    setAttr.value = themeSettings.language;
    changeLanguage(setAttr)
